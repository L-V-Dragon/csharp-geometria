...
Console.WriteLine();
while (rettangoloU.baseRettangolo == rettangoloU.altezzaRettangolo)
{
    Console.WriteLine("Questo è un quadrato, un rettangolo ha base e altezza diverse");
    Console.WriteLine();

    Console.WriteLine("Re-inserisci la base del tuo rettangolo");
    rettangoloU.baseRettangolo = int.Parse(Console.ReadLine());
    Console.WriteLine();

    Console.WriteLine("Re-inserisci l'altezza del tuo rettangolo");
    rettangoloU.altezzaRettangolo = int.Parse(Console.ReadLine());
    Console.WriteLine();
